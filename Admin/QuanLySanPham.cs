...

{
...

    {
...

                    {
...

                        {
                            ...
                            if (txtSLT.Text == string.Empty)
                                ...
                                insertRow["SoLuongTon"] = txtSLT.Text;
...

                    {
...

                        {
                            ...
                            if (txtSLT.Text == string.Empty)
                                ...
                                updateRow["SoLuongTon"] = txtSLT.Text;
...

        {
            ...
            DialogResult r = MessageBox.Show("Bạn có muốn xóa sản phẩm này không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
...

                {
...

                    {
...

                        {
                            ...
                            MessageBox.Show("Trùng Mã danh mục!!!");
...

        {
            ...
            DialogResult r = MessageBox.Show("Bạn có muốn xóa danh mục này không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
...

            {
...

                {
...

                    {
                        ...
                        MessageBox.Show("Không thể xóa do đang có sản phẩm liên dùng danh mục này!!!");
